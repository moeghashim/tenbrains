...
export const defaultModels = { mock: 'mock', anthropic: 'claude-sonnet-5', openai: 'gpt-5.6-luna', 'claude-subscription': 'claude-sonnet-5', 'codex-subscription': 'gpt-6-astra', 'grok-subscription': 'grok-build' };
